...
import (
	...
	"github.com/cafebazaar/keepalived-exporter/pkg/collector"
...
func main() {
	...
	keepalivedCollector := collector.NewKeepalivedCollector(*keepalivedJSON, *keepalivedPing, *keepalivedPID)
